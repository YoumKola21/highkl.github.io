...
const change_img_data = () =>{
    setTimeout(() => {
        img_change.style.background = "url('C:/Users/User/897.jpg') no-repeat center center/cover";
    }, 3000);
    setTimeout(() => {
        img_change.style.background = "url('C:/Users/User/2f81eaed8ecbc91322df8b5c417d1ab8.jpg') no-repeat center center/cover";
    }, 6000);
    setTimeout(() => {
        img_change.style.background = "url('file:///C:/Users/User/2070156.webp') no-repeat center center/cover";
    }, 9000);
    setTimeout(() => {
        img_change.style.background = "url('file:///C:/Users/User/1885324.webp') no-repeat center center/cover";
    }, 12000);
}
