...
const change_img_data = () =>{
    setTimeout(() => {
        img_change.style.background = "url('C:/Users/User/sniper-ghost-warrior-2-wallpaper-12.jpg') no-repeat center center/cover";
    }, 3000);
    setTimeout(() => {
        img_change.style.background = "url('C:/Users/User/desktop-wallpaper-sniper-ghost-warrior-rifle-heavy.jpg') no-repeat center center/cover";
    }, 6000);
    setTimeout(() => {
        img_change.style.background = "url('C:/Users/User/3309648.jpg') no-repeat center center/cover";
    }, 9000);
    setTimeout(() => {
        img_change.style.background = "url('file:///C:/Users/User/Sniper_Ghost_Warrior_Contracts_2_For_PS5_Delayed_gaming_instincts_tv_website_youtube_thumbnail.webp') no-repeat center center/cover";
    }, 12000);
}
