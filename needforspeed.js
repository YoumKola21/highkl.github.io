...
const change_img_data = () =>{
    setTimeout(() => {
        img_change.style.background = "url('C:/Users/User/needforspeed1.png') no-repeat center center/cover";
    }, 3000);
    setTimeout(() => {
        img_change.style.background = "url('file:///C:/Users/User/needforspeed2.webp') no-repeat center center/cover";
    }, 6000);
    setTimeout(() => {
        img_change.style.background = "url('C:/Users/User/needforspeed3.jpg') no-repeat center center/cover";
    }, 9000);
    setTimeout(() => {
        img_change.style.background = "url('C:/Users/User/needforspeed4.jpg') no-repeat center center/cover";
    }, 12000);
}
