...
const change_img_data = () =>{
    setTimeout(() => {
        img_change.style.background = "url('C:/Users/User/zz.jpg') no-repeat center center/cover";
    }, 3000);
    setTimeout(() => {
        img_change.style.background = "url('C:/Users/User/zzz.jpg') no-repeat center center/cover";
    }, 6000);
    setTimeout(() => {
        img_change.style.background = "url('file:///C:/Users/User/40632.webp') no-repeat center center/cover";
    }, 9000);
    setTimeout(() => {
        img_change.style.background = "url('C:/Users/User/618410.jpg') no-repeat center center/cover";
    }, 12000);
}
