...
const change_img_data = () =>{
    setTimeout(() => {
        img_change.style.background = "url('C:/Users/User/gotofwar3.jpg') no-repeat center center/cover";
    }, 3000);
    setTimeout(() => {
        img_change.style.background = "url('C:/Users/User/gotofwar1.jpg') no-repeat center center/cover";
    }, 6000);
    setTimeout(() => {
        img_change.style.background = "url('C:/Users/User/gotofwar2.jpg') no-repeat center center/cover";
    }, 9000);
    setTimeout(() => {
        img_change.style.background = "url('C:/Users/User/gotofwar.jpg') no-repeat center center/cover";
    }, 12000);
}
