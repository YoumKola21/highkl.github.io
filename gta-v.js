...
const change_img_data = () =>{
    setTimeout(() => {
        img_change.style.background = "url('C:/Users/User/65.jpg') no-repeat center center/cover";
    }, 3000);
    setTimeout(() => {
        img_change.style.background = "url('C:/Users/User/michael-franklin-trevor-in-gta-5-wallpaper.jpg') no-repeat center center/cover";
    }, 6000);
    setTimeout(() => {
        img_change.style.background = "url('file:///C:/Users/User/wp5334289.webp') no-repeat center center/cover";
    }, 9000);
    setTimeout(() => {
        img_change.style.background = "url('C:/Users/User/1001575.jpg') no-repeat center center/cover";
    }, 12000);
}
