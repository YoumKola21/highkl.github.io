...
const change_img_data = () =>{
    setTimeout(() => {
        img_change.style.background = "url('file:///C:/Users/User/1470805.webp') no-repeat center center/cover";
    }, 3000);
    setTimeout(() => {
        img_change.style.background = "url('C:/Users/User/wallpapersden.com_call-of-duty-mobile-key-art_3840x2160.jpg') no-repeat center center/cover";
    }, 6000);
    setTimeout(() => {
        img_change.style.background = "url('C:/Users/User/call-of-duty-black-ops-4-poster_3840x2160_xtrafondos.com.jpg') no-repeat center center/cover";
    }, 9000);
    setTimeout(() => {
        img_change.style.background = "url('C:/Users/User/1044064.jpg') no-repeat center center/cover";
    }, 12000);
}
